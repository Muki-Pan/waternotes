...
Water Notes 最初是一个个人项目：我想要有一个安静的地方，记录自己看过的展览、喜欢的图像、艺术家线索、田野笔记和日常的视觉碎片。

后来我意识到，很多人也许也需要这样一个空间：一个可以慢慢收集、慢慢回看、慢慢形成自己观看脉络的地方。
...
| 项目 | 值 |
| --- | --- |
| Git repository | `Muki-Pan/waternotes` |
...
Water Notes 最初是一个用来收集展览、图像和视觉碎片的个人工具。

现在把它整理出来，是希望更多人也可以拥有自己的展览收集册、视觉札记和独立的小小档案。
